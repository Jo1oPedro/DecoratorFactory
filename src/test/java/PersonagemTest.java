...
public class PersonagemTest {
    ...
    public void deveRetornarPersonagemComCapaceteMaisPeitoralMaisLuva() {
        ...
        assertEquals("personagem / capacete / peitoral / luva", capacete.getNomeSet());
    }
}
